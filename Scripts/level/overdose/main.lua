...
function SetColorScheme(mScheme)
	MAIN_COLOR[1], MAIN_COLOR[2], MAIN_COLOR[3] = COLORSCHEMES[mScheme][1][1], COLORSCHEMES[mScheme][1][2], COLORSCHEMES[mScheme][1][3]
	   BG_COLOR1[1], BG_COLOR1[2], BG_COLOR1[3] = COLORSCHEMES[mScheme][2][1], COLORSCHEMES[mScheme][2][2], COLORSCHEMES[mScheme][2][3]
	   BG_COLOR2[1], BG_COLOR2[2], BG_COLOR2[3] = COLORSCHEMES[mScheme][3][1], COLORSCHEMES[mScheme][3][2], COLORSCHEMES[mScheme][3][3]
end
