Fake = {pivotQuads = {}, baseThickness = 5, pulse3D = 1, pulse3DDirection = 1, newPos = {0, 0}, center = {0, 0}, realOffset = {0, 0}}
...
function Fake:updateVisuals(depth)
	...
	self.newPos = {offset * math.cos(rotation) + self.center[1] + self.realOffset[1], offset * math.sin(rotation) + self.center[2] + self.realOffset[2]}
