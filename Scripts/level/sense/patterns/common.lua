...
function getSideDistanceOld(mSide1, mSide2)
...
function getSideDistanceNew(mSide1, mSide2)
  mSide1 = mSide1 % l_getSides();
  mSide2 = mSide2 % l_getSides();
  if (mSide2 > mSide1 + (l_getSides() / 2)) then
    mSide2 = math.abs(mSide2 - l_getSides());
  elseif mSide2 < mSide1 - (l_getSides() / 2) then
    mSide2 = math.abs(mSide2 + l_getSides());
  end
    return math.abs(mSide2 - mSide1);
end
