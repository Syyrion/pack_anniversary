...
function crstWhatWalls(mCount)
    ...
    for a = 0, mCount do
        cursedSkewedWall(math.random() * sides, math.random() * (0.225 * (sides / 6)) * getRandomDir() * thickness,
            thilvue(thickness), math.random() * (a + 2) * 20, math.random() * 50 * getRandomDir(), sides)
    end
