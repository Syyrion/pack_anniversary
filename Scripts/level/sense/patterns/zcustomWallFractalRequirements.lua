...
function imposterWallFract:move(mFrameTime)
    ...
    trueSideFrac = self.sideFrac +
        math.sin(l_getLevelTime() * self.curveSpeedFrac + self.curveStartFrac + self.curveStartIncFrac) * self.curveFrac
...
function wImpWallFrac(mSide, mSidewidth, mSidewidthBase, mSidewidthThickness, mDistance, mSpeed, mThickness, mShape, mRed
                      , mGreen, mBlue, mAlpha, mCurve, mCurveStart, mCurveStartInc, mCurveSpeed, mRedB, mGreenB, mBlueB,
                      mAlphaB, mRedC, mGreenC, mBlueC, mAlphaC, mRedD, mGreenD, mBlueD, mAlphaD, mColoring)
    cwFract = cw_create()
