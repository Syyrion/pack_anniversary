...
function spawnMainPattern(mNumbSpawn)
    ...
    elseif mNumbSpawn ==  1 then pMarch31osWhirlwindRev(_side, u_rndInt(7, 11), 1, 0, 0, getPolySides(3, "floor"), 1, true, 1, 1, getRandomDir(), 1, 1, 1, true)
    ...
    elseif mNumbSpawn == 12 then pMarch31osWhirlwindRev(_side, u_rndInt(4, 7), 1, u_rndInt(0, 2), 0, getPolySides(3, "floor"), 1, true, 1, 1, getRandomDir(), 1, 1, 1, true)
...
function spawnHxdsHexV1Pattern(mNumbSpawn)
    local _side = getRandomSide();
        if mNumbSpawn ==  0                            then pMarch31osAlternatingBarrage(_side, march31oPat_thickness, u_rndInt(3, 5), true, false, 1, 0, 1, false, 1, 1, getRandomDir())
    ...
    elseif mNumbSpawn ==  3 and getProtocolSides() > 5 then pMarch31osBackAndForthTunnelCentral(_side, march31oPat_thickness, nil, u_rndInt(3, 4) * 2, 0, 0, 0, 0, 1, 1, u_rndInt(0, 1), 0, true)
...
function spawnHxdsCrazyPentPattern(mNumbSpawn)
        if mNumbSpawn ==  0 then pMarch31osAlternatingBarrage(_side, march31oPat_thickness, u_rndInt(3, 4), true, false, 1, 0, 1, false, 1, 1, getRandomDir())
...
function spawnHxdsV2Pattern(mNumbSpawn, bIsGearTeeth)
    ...
    elseif mNumbSpawn == 12 then pMarch31osWhirlwindRev(_side, u_rndInt(5, 8), 1, 0, 0, getPolySides(3, "floor"), 1, true, 1, 1, getRandomDir(), 0, 0, 0, false)
    elseif mNumbSpawn == 13 then pMarch31osWhirlwindRev(_side, u_rndInt(12, 15), 1, 0, 0, 1, 1, true, 0.75, 1, getRandomDir(), 0, 0, 0, false)    
...
function spawnSHPattern(mNumbSpawn, mSpawnType, bIsHyper, bIsFinalEngage)
    ...
    if mSpawnType == 0 then
        ...
        elseif mNumbSpawn == 10 then
            ...
            elseif getProtocolSides() == 4 then pMarch31osWhirlwindRev(_side, 0, 1, 0, 0, getPolySides(3, "floor"), 1, true, 1, 1, getRandomDir(), 1, 1, 1, true)
            end
    ...
    elseif mSpawnType == 1 then
        ...
        elseif mNumbSpawn == 10 and (bIsHyper)     then pMarch31osWhirlwindRev(_side, 4, 1, 0, 0, getPolySides(3, "floor"), 1, true, 1, 1, getRandomDir(), 1, 1, 1, true);
        ...
        elseif mNumbSpawn == 15 and (bIsHyper)     then pMarch31osTunnel(_side, march31oPat_thickness, nil, 3, 2, 1, 1, 1, 0, 0, true, true, 1, 1, 0, 0, 1, nil, 1, 1, true, false)
    ...
    elseif mSpawnType == 2 then
        ...
        elseif mNumbSpawn == 10                      then pMarch31osWhirlwindRev(_side, 4, 1, 0, 0, getPolySides(3, "floor"), 1, true, 1, 1, getRandomDir(), 1, 1, 1, true);
        ...
        elseif mNumbSpawn == 16                      then pMarch31osTunnel(_side, march31oPat_thickness, nil, 3, 2, 1, 1, 1, 0, 0, true, true, 1, 1, 0, 0, 1, nil, 1, 1, true, false);
        elseif mNumbSpawn == 17                      then pMarch31osAlternatingBarrage(_side, march31oPat_thickness, 4, false, false, 0, 0, 2, false, 1, 1, getRandomDir());
        end
    end
end
