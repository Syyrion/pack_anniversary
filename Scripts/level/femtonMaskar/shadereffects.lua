...
function bgBlackBoxes(mDelay, mSpeed)
    ...
    for i = 0, 5 do
        ...
        ct_eval(timelineBGDiamonds,
            string.format("wNewDeco(0, 0, 20, 0, 20, 20, 0, 20, 255, 255, 255, 110, %f, 3, 0, %f)", spd, dir))
    end
...
function bgBlackBoxplosion(mAmount, mSpeed)
    ...
    for i = 0, mAmount / 2 do
        dir = math.random(0, 360)
        ct_eval(timelineBGDiamondsPulse,
            string.format("wNewDeco(0, 0, 20, 0, 20, 20, 0, 20, 255, 255, 255, 180, %f, 3, 0, %f)", spd, dir))
        dir = math.random(0, 360)
        ct_eval(timelineBGDiamondsPulse,
            string.format("wNewDeco(0, 0, 20, 0, 20, 20, 0, 20, 255, 255, 255, 180, %f, 3, 0, %f)", spd, dir))
