...
function pRandomBarrage(mTimes,mDelay)
	...
	for i = 0, mTimes do	
		...
		if (l_getSides() < 5 and math.random(0,2) == 0 and i ~= mTimes and fastflip == false and u_getDifficultyMult() == 3.0) then 
...
function onUpdate(mFrameTime)
    ...
    shdr_setUniformFVec4(gradientShaderId, "u_pulsecolor", shdrPulseColor[1], shdrPulseColor[2], shdrPulseColor[3], shdrPulseColor[4]);
